...
class TestAppService:
    ...
    def test_create_default(self, mock_simple_downloader, mock_db_operator, mock_get_config):
        ...
        mock_db_operator.return_value = mock_db_instance
        mock_simple_downloader.return_value = mock_downloader_instance
        ...
        mock_db_operator.assert_called_once_with(":memory:")
        mock_simple_downloader.assert_called_once()
...
class TestServiceFactory:
    ...
    def test_create_app_service_with_defaults(self, mock_db_operator, mock_get_config):
        ...
        with patch('neo.downloader.simple_downloader.SimpleDownloader') as mock_simple_downloader:
            mock_downloader_instance = Mock(spec=IDownloader)
            mock_simple_downloader.return_value = mock_downloader_instance
