...
def _download_task_impl(task_type: str, symbol: str) -> dict:
    """下载任务的实际实现，用于测试"""
    import logging
    from neo.task_bus.types import DownloadTaskConfig, TaskResult, TaskType, TaskPriority
...
class TestDownloadTask:
    ...
    def test_download_task_success(self):
        ...
        with patch('neo.downloader.simple_downloader.SimpleDownloader') as mock_downloader_class:
            ...
            assert result["config"]["task_type"] == "stock_basic"  # 序列化后应该是字符串
