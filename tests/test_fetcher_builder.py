...
from src.downloader.producer.fetcher_builder import (
    TaskTemplate,
    TaskType,
    TushareApiManager,
    FetcherBuilder
...
class TestTushareApiManager:
    ...
    @patch('src.downloader.producer.fetcher_builder.ts')
    @patch('src.downloader.producer.fetcher_builder.get_config')
...
class TestFetcherBuilder:
    ...
    @patch('src.downloader.producer.fetcher_builder.normalize_stock_code')
