...
class TestSimpleDownloaderDownload:
    ...
    def test_download_with_kwargs(self):
        ...
        # 使用额外参数调用
        result = self.downloader.download("stock_basic", "000001.SZ", start_date="20240101")
    ...
    def test_download_with_rate_limit_manager_exception(self):
        """测试速率限制管理器抛出异常的情况"""
        # 模拟速率限制管理器抛出异常
        self.mock_rate_limit_manager.apply_rate_limiting.side_effect = Exception("Rate limit error")
