...
class TaskFilter:
    ...
    def _load_config(self) -> None:
        ...
        self.exchange_whitelist = task_filter_config.get('exchange_whitelist', ['SH', 'SZ'])
    ...
    def filter_data(self, data: List[Dict[str, Any]], symbol_column: str = 'ts_code') -> List[Dict[str, Any]]:
        """过滤数据列表
        ...
        filtered_data = []
        for item in data:
            if symbol_column in item and self.should_process_symbol(item[symbol_column]):
