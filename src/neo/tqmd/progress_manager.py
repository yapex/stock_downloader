...
class ProgressManager:
    ...
    def __init__(self, factory: IProgressTrackerFactory):
        ...
        self._task_type_trackers: dict[str, IProgressTracker] = {}  # 按任务类型的子进度条
    
    def start_group_progress(self, total_tasks: int, description: str = "处理下载任务") -> None:
        """开始组级别进度跟踪（母进度条）
    ...
    def update_task_type_progress(self, task_type: str, increment: int = 1, completed: int = None, total: int = None) -> None:
        """更新任务类型级别进度
